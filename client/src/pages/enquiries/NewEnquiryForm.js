...
const NewEnquiryForm = ({ onSuccess }) => {
  ...
  const handleDateChange = (name, value) => setFormValues({ ...formValues, [name]: value });
        ...
        return (
          <Grid item xs={12} md={6} key={key}>
            <FormControl fullWidth>
              ...
              <Select name={key} value={value} onChange={handleChange} label={formatLabel(key)}>
                {users.map((u) => (
        ...
        return (
          <Grid item xs={12} key={key}>
            <FormControl fullWidth>
              ...
              <Select name="workflow_id" value={value} onChange={handleChange} label="Select Workflow">
                {workflows.map((wf) => (
