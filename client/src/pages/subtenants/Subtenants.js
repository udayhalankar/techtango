...
{ field: 'subtenantname', value: 'subtenantname',  headerName: 'subtenantname', type: 'string', width: 150, editable: false },
...
const Subtenants = () => {
  ...
  const { isLoading, data } = useQuery({
    ...
    queryKey: ["allusers"],
    queryFn: () =>
      fetch("http://localhost:5000/subtenants").then(
        (res) => res.json()
      ),
  });
