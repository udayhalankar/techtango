                    ...
                    {myWorkTodayStats.map(({ label, value, Icon }) => (
                      <Grid item xs={6} sm={3} md={6} lg={3} key={label}>
                        ...
                        >
                          ...
                          <Typography sx={{ color: "#fff", fontWeight: 900, fontSize: 24, lineHeight: 1.1 }}>
                            {value}
                          </Typography>
                          <Typography sx={{ color: "#d6e2f2", fontSize: 11, fontWeight: 700 }}>
                            {label}
                          </Typography>
                        </Box>
                      </Grid>
        ...
        <Grid container spacing={2.5} sx={{ mt: 1.5, alignItems: "stretch" }}>
          <Grid item xs={12} md={8}>
            <Paper
              ...
              >
                <Typography sx={{ fontWeight: 800, color: "#152238", fontSize: 20 }}>
                  Recent Activity
                </Typography>
                    ...
                    return (
                      ...
                      >
                        ...
                        <Box sx={{ minWidth: 0, flex: 1 }}>
                          <Typography sx={{ fontWeight: 700, color: "#152238", fontSize: 14 }}>
                            {item.title}
                          </Typography>
