...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('WorkflowInstance', {
    ...
    stepName: { type: DataTypes.TEXT, allowNull: true, field: 'step_name' },
assignedTo: { type: DataTypes.INTEGER, allowNull: true, field: 'assigned_to' },
stepDueDate: { type: DataTypes.DATE, allowNull: true, field: 'step_due_date' },
updateformId: { type: DataTypes.INTEGER, allowNull: true, field: 'updateform_id' },
